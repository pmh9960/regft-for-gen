...
class ImageFolderWithPaths(datasets.ImageFolder):
    def __init__(self, path, transform, target_transform=None, flip_label_prob=0.0):
...
def get_dataloader(dataset, is_train, args, image_encoder=None):
    if image_encoder is not None:
        ...
        dataloader = DataLoader(feature_dataset, batch_size=args.batch_size, shuffle=is_train, num_workers=args.num_workers)
    else:
